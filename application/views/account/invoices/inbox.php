<div class="row">
  <div class="col-md-4 mb-2">
    <h5><?php echo lang('users invoices inbox'); ?></h5>
  </div>
  <div class="col-md-8 mb-2 text-right">
    <div class="btn-group" role="group" aria-label="Basic example">
      ...
      <a href="<?php echo base_url('account/invoices/inbox'); ?>" class="btn btn-outline-secondary btn-sm active"><i class="icon-drawer icons"></i> <?php echo lang('users invoices inbox'); ?></a>
